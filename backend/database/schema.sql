...
CREATE TABLE IF NOT EXISTS courses (
    ...
    course_type VARCHAR(50) DEFAULT 'pre-recorded' CHECK (course_type IN ('pre-recorded', 'live', 'hybrid')),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE INDEX idx_payments_student_clerk_id ON payments(student_clerk_id);

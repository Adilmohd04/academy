...
import * as timeSlotService from '../../shared/services/timeSlotService';
...
export const getAllTimeSlots = async (req: Request, res: Response) => {
  try {
    console.log('🔍 getAllTimeSlots called - query:', req.query);
    ...
    console.log('✅ Returning', result.length, 'time slots');
    res.json(result);
  } catch (error: any) {

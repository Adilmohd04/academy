...
router.get('/profile', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    if (!user) {
      ...
      const newUser = await UserService.upsertUser(userId, {
 ...
 * Get all teachers for admin to assign to meetings and for public browsing
 * Made public to allow course browse page to load teacher names
 */
